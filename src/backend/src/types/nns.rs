...
#[derive(CandidType, Deserialize)]
pub struct DateUtc { pub day: u32, pub month: u32, pub year: u32 }
...
#[derive(CandidType, Deserialize)]
pub struct DeregisterKnownNeuron { pub id: Option<NeuronId> }
...
#[derive(CandidType, Deserialize)]
pub struct NeuronIndexData { pub neurons: Vec<NeuronInfo> }

#[derive(CandidType, Deserialize)]
pub enum GetNeuronIndexResult { Ok(NeuronIndexData), Err(GovernanceError) }
...
#[derive(CandidType, Deserialize)]
pub enum Vote { No, Yes, Unspecified }
...
impl Service {
  ...
  pub async fn get_neuron_index(&self, arg0: GetNeuronIndexRequest) -> Result<
  ...
  pub async fn list_neuron_votes(&self, arg0: ListNeuronVotesRequest) -> Result<
